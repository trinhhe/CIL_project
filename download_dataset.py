...
download_folder = "E:\\ETH\\Computational Intelligence lab\\Project\\Dataset\\Train\\GroundTruth"
...
class downloader:
    ...
    def __init__(self):
        ...
        self.url = "https://www.cs.toronto.edu/~vmnih/data/mass_roads/train/map/index.html"
    ...
    def loadBrowser(self):
        ...
        try:
            ...
            self.browser = webdriver.Chrome(chrome_options=self.settings, executable_path=r"C:/Users/PC/Downloads/chromedriver_win32/chromedriver.exe")
